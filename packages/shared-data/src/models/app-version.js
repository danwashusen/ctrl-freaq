 ...
 */
export class AppVersionRepositoryImpl extends BaseRepository {
    constructor(db) {
    ...
    async create(versionData) {
        ...
        return super.create(dataWithMigration);
    }
    /**
 ...
 */
export const validateAppVersion = (data) => {
    return AppVersionSchema.parse(data);
};
export const validateCreateAppVersion = (data) => {
    return CreateAppVersionSchema.parse(data);
};
export const validateUpdateAppVersion = (data) => {
...
export const AppVersionUtils = {
     ...
     */
    getNextMinorVersion(currentVersion) {
        const parsed = AppVersionUtils.parseVersion(currentVersion);
     ...
     */
    getNextMajorVersion(currentVersion) {
        const parsed = AppVersionUtils.parseVersion(currentVersion);
     ...
     */
    formatMigrationNotes(version, changes) {
