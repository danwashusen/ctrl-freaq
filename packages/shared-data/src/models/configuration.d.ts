 ...
 */
export declare const CreateConfigurationSchema: z.ZodObject<Omit<{
    id: z.ZodString;
    userId: z.ZodString;
    key: z.ZodString;
    value: z.ZodString;
 ...
 */
export declare const UpdateConfigurationSchema: z.ZodObject<Omit<{
...
}, "userId" | "key" | "id" | "createdAt" | "updatedAt">, "strip", z.ZodTypeAny, {
 ...
 */
export declare class ConfigurationRepositoryImpl extends BaseRepository<Configuration> implements ConfigurationRepository {
 ...
 */
export declare const VALID_CONFIG_KEYS: readonly ["theme", "logLevel", "editorPreferences", "apiKeys", "notifications", "language"];
...
export declare const CONFIG_CONSTANTS: {
    ...
    readonly VALID_KEYS: readonly ["theme", "logLevel", "editorPreferences", "apiKeys", "notifications", "language"];
};
