 ...
 */
export declare const CreateActivityLogSchema: z.ZodObject<Omit<{
    id: z.ZodString;
    userId: z.ZodString;
    action: z.ZodString;
    resourceType: z.ZodString;
 ...
 */
export declare class ActivityLogRepositoryImpl extends BaseRepository<ActivityLog> implements ActivityLogRepository {
...
export declare const ActivityLogUtils: {
     ...
     */
    createLogEntry(userId: string, action: ActionType, resourceType: ResourceType, resourceId: string, metadata?: Record<string, any>, request?: {
        ip?: string;
        userAgent?: string;
...
export declare const ACTIVITY_LOG_CONSTANTS: {
    ...
    readonly VALID_ACTIONS: ("auth.login" | "auth.logout" | "auth.refresh" | "auth.failed" | "project.create" | "project.update" | "project.delete" | "project.view" | "config.update" | "config.view" | "config.reset" | "system.start" | "system.error" | "system.migration")[];
