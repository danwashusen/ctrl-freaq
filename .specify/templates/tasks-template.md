...
- [ ] Each user story phase contains all tasks required to deliver that story independently
- [ ] All tasks specify repository-root anchored file paths
- [ ] `[P]` tasks operate on disjoint files with no hidden dependencies
- [ ] Tests (when requested) appear before implementation tasks for the same story
- [ ] Foundational tasks exist before any user story begins
- [ ] Dependencies and parallel execution notes are documented in the summary section
